                ...
                , div [ class "w-50-ns dib-ns tr-ns" ]
                    ...
                    , div [ class "w-60-ns tl dib" ]
                        [ div [ class "w-100 relative dib" ]
                            [ div [ class "w-100 pv2 b--lm-dark-turquoise ba pointer tc lm-bg-dark-turquoise-hover", onClick ToggleOrderBox ]
...
order_box visible =
    if visible then
        div [ class "absolute bg-white z-100 w-100 left-0 bb bl br b--lm-dark-turquoise tc pointer" ]
