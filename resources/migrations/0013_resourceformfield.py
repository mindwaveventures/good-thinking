# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-08-09 11:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('resources', '0012_auto_20170808_1351'),
    ]

    operations = [
        migrations.CreateModel(
            name='ResourceFormField',
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='resources.ResourceIndexPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
